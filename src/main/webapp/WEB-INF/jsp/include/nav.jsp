...
<ul class="nav nav-fill w-100">
	<li class="nav-item"><a href="#" class="nav-link nav-font-color"><img src="/static/image/hotelIcon.png" width="28px">숙소/예약</a></li>
	<li class="nav-item"><a href="#" class="nav-link nav-font-color">관광지/추천</a></li>
	<li class="nav-item"><a href="#" class="nav-link nav-font-color">식당/푸드트럭</a></li>
